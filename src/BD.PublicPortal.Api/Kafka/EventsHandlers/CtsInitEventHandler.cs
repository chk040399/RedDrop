...
using BD.PublicPortal.Api.Kafka.EventsCommands;
using Infrastructure.Configuration;

namespace BD.PublicPortal.Api.Kafka.EventHandlers;

  public class CtsInitEventHandler
      : IRequestHandler<CtsInitCommand, Unit>
  {
      private readonly ILogger<CtsInitEventHandler> _logger;
      private readonly IEventProducer _eventProducer;
      private readonly RetryPolicySettings _retrySettings;
      private readonly IOptions<KafkaSettings> _kafkaSettings;

      public CtsInitEventHandler(
          
          ILogger<CtsInitEventHandler> logger,
