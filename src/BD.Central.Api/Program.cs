using System.Text;
using BD.Central.Api.Configurations;
using BD.Central.Api.Kafka;
...
var appLogger = new SerilogLoggerFactory(logger)
    .CreateLogger<BD.Central.Api.Program>();
...
app.MapGet("/", () => "Hello from Central API!");
